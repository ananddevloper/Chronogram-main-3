...
//   // ── Folder selection state ──
//   AssetPathEntity? _selectedFolder;
//   String _selectedFolderName = "Select a Folders";
...
//                 setState(() {
//                   _isFileMode = false;
//                   _selectedFolderName = "Select a Folders";
//                   _selectedFolder = null;
//                 });
//                 _fetchPhotos();
//               } else {
...
//   // ── Folder select — sirf naam update, koi fetch nahi ──
//   void _showFolderPicker() async {
//     try {
...
//   // ── Sync button press — 3 sec green, phir fetch ──
//   void _onSyncPressed() async {
//     if (_selectedDirectoryPath == null) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(
//           content: Text("Pehle ek folder select karo!"),
//           backgroundColor: Colors.orange,
//         ),
//       );
//       return;
...
//                 ),
//               ),
//               child: const Text("Dusra folder select karo"),
//             ),
//           ],
//         ),
//       );
...
//                       fontWeight: FontWeight.bold,
//                     ),
//                     child: Text(_isSynced ? "Synced ✓" : "Sync"),
//                   ),
//                 ],
//               ),
//             ),
...
//       child: Row(
//         children: [
//           const Icon(Icons.folder_open_outlined, color: Colors.orange, size: 20),
//           const SizedBox(width: 10),
//           InkWell(
//             onTap: _showFolderPicker,
//             borderRadius: BorderRadius.circular(6),
...
//     final fileName = path.split('/').last;
//     DateTime? fileDate;
//     try { fileDate = file.lastModifiedSync(); } catch (_) {}
            ...
            Expanded(
              child: Text(
                _selectedPaths.isEmpty
                    ? 'Photos select karo sync karne ke liye'
                    : 'Aapne ${_selectedPaths.length} item select kiya hai sync karne ke liye',
      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                'Aapka $_syncedItemCount item sync hua hai "$_selectedFolderName" se',
